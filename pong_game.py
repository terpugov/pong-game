...
#        ball_vel[0] *= -1
    ...
    # draw score
    if (ball_pos[0] + ball_vel[0]) < (BALL_RADIUS - PAD_WIDTH ) and (ball_pos[1] + ball_vel[1] > paddles1_y1 and ball_pos[1] < paddles1_y2):
        ball_vel[0] *= -1
    if (ball_pos[0] + ball_vel[0]) > (WIDTH - BALL_RADIUS - PAD_WIDTH ) and (ball_pos[1] + ball_vel[1] > paddles2_y1 and ball_pos[1] < paddles2_y2):
        ball_vel[0] *= -1
    
    # collide with border
    if ball_pos[1] + ball_vel[1] < BALL_RADIUS or ball_pos[1] + ball_vel[1]> HEIGHT - BALL_RADIUS: 
        ball_vel[1] *= -1
    if ball_pos[0] + ball_vel[0]  < BALL_RADIUS - PAD_WIDTH or ball_pos[0] + ball_vel[0]  > WIDTH - BALL_RADIUS - PAD_WIDTH:
